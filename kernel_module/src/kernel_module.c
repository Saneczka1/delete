...
#define SYKT_GPIO_ARG2_ADDR (+0x0388)
//#define SYKT_GPIO_CTRL_ADDR (SYKT_GPIO_ADDR_SPACE+0x000003A1)
#define SYKT_GPIO_ARG1_ADDR (0x0380)
#define SYKT_GPIO_RESULT_ADDR (0x0390)
#define SYKT_GPIO_ONES_ADDR (0x0398)
#define SYKT_GPIO_STATUS_ADDR (0x03A0)
